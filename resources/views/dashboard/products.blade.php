...
@section('scripts')
     <script>  
        ...
        function getPagination(currentPage){ 
            ...
            fetch('{{$menu['baseURL']."/products/list?page="}}'+currentPage+'&s='+s, { 
                headers: { 
        ...
        function setRows(data){ 
            ...
            if(data.length){
                ...
                data.forEach(product => { 
                    ...
                    let rowHTML = '<tr class="border-b border-gray-200"><td scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap flex items-center"><img width="40" src="'+product.image+'" class="rounded-full mr-2" /><a href="{{$menu['baseURL'].$menu['route']['products']['edit']('')}}'+product.id+'"  class="font-bold text-[#526270]">'+product.name+'</a></td>'+
