...
<section class="bg-white px-0 md:px-5 pt-5 pb-5 w-full lg:w-5/6 rounded-lg m-auto mt-5">
    ...
    <hr />
    <form action="">
        <div class="grid grid-cols-1 gap-4 md:gap-8 md:grid-cols-2 m-2 md:m-10 md:mt-2"> 
            <div class="col-span-2 md:col-span-1">
                <div class="autocomplete relative group">
                    <input type="text" name="clients" id="clients" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="col-span-2 md:col-span-1">
                <div class="autocomplete relative group">
                    <input type="text" name="appointments" id="appointments" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <div class="col-span-2 md:col-span-1  mt-[18px]">
                <div class="relative z-0 group">
                    <input type="email" name="floating_email" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    <label for="floating_email" class="peer-focus:font-medium absolute text-sm text-[#526270] duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Notas de venta</label>
                </div>
            </div> 
            ...
            <div class="col-span-2 mt-4 text-right">
                <button type="button" onClick={chargeSelling} class="bg-violet-600 text-white border-violet-600 border-2 rounded-md px-10 py-1 mr-2">
                    Cobrar
                </button>
                <button type="button" onClick={saveSelling} class="bg-violet-600 text-white border-violet-600 border-2 rounded-md px-10 py-1">
                    Guardar
                </button>
            </div>
        </div>
...
<script>
    const newRow = '<div class="overflow-x-auto overflow-y-none h-[200px] item-row">'+
                        '<div class="grid grid-cols-4 gap-4 min-w-[700px]">'+
                            ...
                            '<div class="pl-1">'+
                                '<div class="autocomplete relative group">'+
                                    '<input value="Servicios" type="text" name="type[]" class="types block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
                            ...
                            '<div>'+
                                '<div class="autocomplete relative group">'+
                                    '<input type="text" name="services[]" class="services block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
                                ...
                                '<div class="autocomplete relative group" style="display:none">'+
                                    '<input type="text" name="products[]" class="products block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
                            ...
                            '<div class="flex gap-1">'+
                                '<div class="relative z-0 mt-1 group">'+
                                    '<input readOnly  value="0" type="text" name="price[]" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
                                ...
                                '</div>'+
                                '<div class="relative z-0 mt-1 group">'+
                                    '<input min="1" onchange="changeQty()" value="1" type="number" name="qty[]" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
                            ...
                            '<div>'+
                                '<div class="relative z-0 mt-1 group">'+
                                    '<input type="text" name="users[]" class="users block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-[1px] border-[#526270] appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required/>'+
    ...
    function autocomplete(inp, arr, callback) { 
        ...
        inp.addEventListener("click", (e) => { 
            ...
            for (i = 0; i < arr.length; i++) {
                ...
                if (!val) { 
                    ...
                    b.addEventListener("click", (e) => {console.log(event.target.parentNode);
        ...
        function removeActive(x) {console.log("remove");
    ...
    function handleDeleteItem(){
        console.log(event.target.parentNode.parentNode.parentNode.parentNode.remove());
    }
    ...
    autocomplete(document.querySelector("#appointments"), appointments);
  </script>
@stop
