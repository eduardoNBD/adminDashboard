                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    ...
                    <!--<a href="{{$menu['baseURL'].$menu['route']['appointments']['calendar']}}" class="flex items-center justify-center border-2 border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2">
                        <svg  
                            ...
                            class="flex-shrink-0 w-5 h-5 w-6 h-6">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 ">¿Estas seguro de cancelar la cita?</h3>
...
@section('scripts')
     <script>  
        ...
        function getPagination(currentPage){ 
            ...
            .then((json) => { console.log(json);
                if(json.status)
                {
                    ...
                    setRows(json.appointments.data);
                }
                else{
        ...
        {
            fetch('{{$menu['baseURL']."/appointments/delete/"}}'+currentAppointment, { 
                headers: { 
                    "X-CSRF-Token": document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                },    
            })
