<section class="bg-gradient-to-r from-violet-600 to-violet-300 relative shadow-md rounded-2xl p-8 h-full"> 
        ...
        <main class="col-span-4 md:col-span-2">
            <article class="p-10 text-white">
                <section class="flex">
                    ...
                    <img class="w-6/12 -mt-10 ml-auto hidden xs:block md:hidden" src="{{asset('../resources/img/welcome.png') }}" alt="">
                </section>
                <div class="grid grid-cols-2 mt-10 gap-3">
                    <a href="{{$menu['baseURL'].$menu['route']['appointments']['new']}}" class="col-span-2 sm:col-span-1 w-full text-center m-auto hover:bg-indigo-700 bg-indigo-600 text-white group px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg flex justify-center items-center">
                    ...
                    @if(Auth::user()->role == 1)
                        <a href="{{$menu['baseURL'].$menu['route']['sellings']['new']}}" class="col-span-2 sm:col-span-1 w-full text-center m-auto hover:bg-indigo-700 bg-indigo-600 text-white group px-4 py-2.5 text-sm font-medium transition-all duration-200 rounded-lg flex justify-center items-center">
